...
execute positioned ~ ~ ~1 if block ~ ~ ~ #minecraft:leaves[persistent=false] unless entity @e[type=area_effect_cloud,tag=TC_Leaf,distance=..0.1] run function treecapitator:z_run/detect_leaves/check_distance
execute positioned ~ ~ ~-1 if block ~ ~ ~ #minecraft:leaves[persistent=false] unless entity @e[type=area_effect_cloud,tag=TC_Leaf,distance=..0.1] run function treecapitator:z_run/detect_leaves/check_distance
execute positioned ~1 ~ ~ if block ~ ~ ~ #minecraft:leaves[persistent=false] unless entity @e[type=area_effect_cloud,tag=TC_Leaf,distance=..0.1] run function treecapitator:z_run/detect_leaves/check_distance
execute positioned ~-1 ~ ~ if block ~ ~ ~ #minecraft:leaves[persistent=false] unless entity @e[type=area_effect_cloud,tag=TC_Leaf,distance=..0.1] run function treecapitator:z_run/detect_leaves/check_distance
execute positioned ~ ~1 ~ if block ~ ~ ~ #minecraft:leaves[persistent=false] unless entity @e[type=area_effect_cloud,tag=TC_Leaf,distance=..0.1] run function treecapitator:z_run/detect_leaves/check_distance
